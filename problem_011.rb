...
# Put numbers into a matrix (array of arrays)
# A method for pulling out 4 numbers left to right could work on an inverted
# matrix. Shifting or popping elements off of adjacent rows then zipping them
# could work for diagonal calculations.
